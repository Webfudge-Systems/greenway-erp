...
import { InfoRow, InfoSection, SidebarCardTitle } from '@greenways/ui';
    ...
    <div className="space-y-4 p-3 sm:space-y-6 sm:p-4 md:p-6">
      ...
      {activeTab === 'overview' ? (
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          <div className="space-y-6 lg:col-span-2">
                  ...
                  <div className="space-y-5">
                    ...
                    <section className="border-t border-gray-100 pt-4">
                      ...
                      {isPresent(project.description) ? (
                        <p className="mt-2.5 line-clamp-4 whitespace-pre-wrap text-base font-normal leading-relaxed text-gray-800 md:line-clamp-none">{project.description}</p>
                      ) : (
            ...
            <Card variant="elevated" className="hidden rounded-xl lg:block">
              <div className="mb-6">
      ...
      {activeTab === 'activity' ? (
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-5 lg:items-start">
          <Card variant="elevated" className="hidden rounded-xl lg:col-span-2 lg:block">
