...
import ClientAccountListMobile from '../../../components/mobile/ClientAccountListMobile';
import { MOBILE_CARD_CLASS } from '../../../components/mobile/mobileCardStyles';
...
export default function ClientAccountsPage() {
  ...
  return (
    <div className="space-y-4 p-3 sm:space-y-6 sm:p-4 md:p-6">
      ...
      {/* Tabs + column picker */}
      <div className="relative z-10" ref={toolbarRef}>
        <TabsWithActions
      ...
      {!loading && paginatedAccounts.length > 0 ? (
        <ClientAccountListMobile accounts={paginatedAccounts} />
      ) : !loading ? (
        <div className={`${MOBILE_CARD_CLASS} p-8 text-center md:hidden`}>
          <Building2 className="mx-auto mb-3 h-12 w-12 text-gray-300" />
          <h3 className="text-lg font-semibold text-gray-700">No client accounts found</h3>
