...
import { buildWorkspaceCalendarEvents, filterWorkspaceCalendarEvents } from '@greenways/utils';
import { Button, Card } from '@greenways/ui';
import { CalendarRange, Loader2 } from 'lucide-react';
import PMPageHeader from '../../components/PMPageHeader';
import { loadWorkspaceCalendarData } from '../../lib/loadWorkspaceCalendar';

const UnifiedWorkspaceCalendar = dynamic(() => import('@greenways/ui').then(m => ({ default: m.UnifiedWorkspaceCalendar })), {
  ssr: false,
  loading: () => (
