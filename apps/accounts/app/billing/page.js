...
import { Badge, Button, Card, KPICard, LoadingSpinner, Table, TableCellText, TableEmptyBelow } from '@greenways/ui'
        ...
        {loading ? (
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
              <KPICard title="Organization status" value={org.status || '—'} icon={CreditCard} />
                ...
                <>
                  <Table
                    ...
                    renderCell={(row, column) => {
                      ...
                      if (column.key === 'cycle') return <TableCellText primary={row.billingCycle || '—'} />
                      if (column.key === 'seats') return <TableCellText primary={String(row.totalUsers ?? '—')} />
